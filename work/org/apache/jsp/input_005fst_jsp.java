...
public final class input_005fst_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(ERMSG != null){ 
      ...
      out.write("      <h3>使用する名刺情報を選択してください</h3>\r\n");
      out.write("      \r\n");
      out.write("      ");
      ...
      out.write("\t      \t\t\t</tr>\r\n");
      out.write("\t      \t\t\t<tr>\r\n");
      out.write("\t      \t\t\t\t<td colspan=\"2\" id=\"sentaku\">\r\n");
      out.write("\t      \t\t\t\t\t<form method=\"post\" action=\"\\syu_pre\\input.jsp\">\r\n");
      out.write("\t      \t\t\t\t\t\t<input type=\"hidden\" name=\"cardid\" value=\"");
      out.print( list.get(i).get("cardid") );
      out.write("\">\r\n");
      out.write("\t      \t\t\t\t\t\t<input type=\"submit\" value=\"選択\" class=\"button2\">\r\n");
      out.write("\t      \t\t\t\t\t</form>\r\n");
      out.write("\t      \t\t\t\t</td>\r\n");
      out.write("\t      \t\t\t</tr>\r\n");
      out.write("\t      \t\t</table>\r\n");
